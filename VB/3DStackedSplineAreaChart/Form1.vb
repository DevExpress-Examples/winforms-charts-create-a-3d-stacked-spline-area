...
Namespace _DStackedSplineAreaChart
    ...
    Public Partial Class Form1
        ...
        Private Sub Form1_Load(ByVal sender As Object, ByVal e As EventArgs)
            ...
            Dim stackedSplineArea3DChart As ChartControl = New ChartControl()
            ' Create two series of the StackedSplineArea3D view type.
            Dim series1 As Series = New Series("Series 1", ViewType.StackedSplineArea3D)
            Dim series2 As Series = New Series("Series 2", ViewType.StackedSplineArea3D)
            ...
            stackedSplineArea3DChart.Legend.Visibility = DevExpress.Utils.DefaultBoolean.False
